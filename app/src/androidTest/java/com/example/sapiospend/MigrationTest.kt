...
import com.example.sapiospend.data.local.LocalOwner
import com.example.sapiospend.data.local.MIGRATION_3_4
...
class MigrationTest {
    ...
    fun migrate3To4_addsTheBudgetLinesTable() = runTest {
        ...
        db.eventDao().insertBudgetLines(
            listOf(
                com.example.sapiospend.data.local.BudgetLineEntity(
